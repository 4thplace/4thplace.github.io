			...
			progress: function(e, data){
				...
				$.each(data.result.files, function(e, tmp){
					if(tmp.error == null){
						...
						var url = tmp.url;
						images[tmp.code] = url;
						var html = '<span class="file-add _img_'+tmp.code+'"><input type="hidden" name="img" value="' + tmp.name + '"><img src="' + CDN_UPLOAD_URL + url + '"><a class="del" href="javascript:;" onclick="SITE_BOOKING_REVIEW.deleteReviewImage(\''+tmp.code+ '\')" ><i class="btm bt-times vertical-middle" aria-hidden="true"></i></a></span>';
