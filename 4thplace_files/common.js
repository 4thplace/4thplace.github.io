...
if(FROALA_VERSION >= 300){
	...
	(function($){
		...
		$.fn.setFroala = function(option){
			...
			if(is_custom_mobile){
				// 모바일 아이콘 변경
				// 다른 아이콘셋과 같이 쓰기 번거로워서 아이콘 클래스명으로 선언할 수 있는 custom_icon 템플릿 선언, CLASSNAME에 i 태그에 들어갈 클래스 넣어서 사용
				$.FroalaEditor.DefineIconTemplate('custom_icon', '<i class="[CLASSNAME]" aria-hidden="true"></i>');
				$.FroalaEditor.DefineIcon(image_insert, {CLASSNAME : 'far fa-images'});
				$.FroalaEditor.DefineIcon('insertVideo', {CLASSNAME : 'fas fa-video'});
				$.FroalaEditor.DefineIcon('insertLink', {CLASSNAME : 'fas fa-link text-16'});
				$.FroalaEditor.DefineIcon('linkList', {CLASSNAME : 'fas fa-search text-16'});
				$.FroalaEditor.DefineIcon('linkOpen', {CLASSNAME : 'fa fa-external-link text-16'});
				$.FroalaEditor.DefineIcon('linkStyle', {CLASSNAME : 'fas fa-magic text-16'});
				$.FroalaEditor.DefineIcon('linkEdit', {CLASSNAME : 'fa fa-edit text-16'});
				$.FroalaEditor.DefineIcon('linkRemove', {CLASSNAME : 'fas fa-unlink text-16'});
				$.FroalaEditor.DefineIcon('linkBack', {CLASSNAME : 'fas fa-arrow-left text-16'});
				$.FroalaEditor.DefineIcon(file_insert, {CLASSNAME : 'far fa-file-alt'});
				$.FroalaEditor.DefineIcon('fontSize', {CLASSNAME : 'fas fa-text-height text-16'});
				$.FroalaEditor.DefineIcon('bold', {CLASSNAME : 'fas fa-bold text-16'});
				$.FroalaEditor.DefineIcon('italic', {CLASSNAME : 'fas fa-italic'});
				$.FroalaEditor.DefineIcon('underline', {CLASSNAME : 'fas fa-underline text-16'});
				$.FroalaEditor.DefineIcon('strikeThrough', {CLASSNAME : 'fas fa-strikethrough text-16'});
				$.FroalaEditor.DefineIcon('align', {CLASSNAME : 'fas fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('align-left', {CLASSNAME : 'fas fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('align-right', {CLASSNAME : 'fas fa-align-right text-16'});
				$.FroalaEditor.DefineIcon('align-center', {CLASSNAME : 'fas fa-align-center text-16'});
				$.FroalaEditor.DefineIcon('align-justify', {CLASSNAME : 'fas fa-align-justify text-16'});
				$.FroalaEditor.DefineIcon('color', {CLASSNAME : 'fas fa-paint-roller text-16'});
				$.FroalaEditor.DefineIcon('clearFormatting', {CLASSNAME : 'fas fa-eraser'});
				$.FroalaEditor.DefineIcon('quote', {CLASSNAME : 'fas fa-quote-left text-16'});
				$.FroalaEditor.DefineIcon('insertHR', {CLASSNAME : 'fas fa-minus'});
				$.FroalaEditor.DefineIcon('formatOL', {CLASSNAME : 'fas fa-list-ol'});
				$.FroalaEditor.DefineIcon('formatUL', {CLASSNAME : 'fas fa-list'});
				// 이하 모바일 뷰에서 사용되지 않지만 모바일 가로보기 등에서 PC 뷰로 변경될 수 있어 추가
				$.FroalaEditor.DefineIcon('fontFamily', {CLASSNAME : 'fas fa-font'});
				$.FroalaEditor.DefineIcon('emoticons', {CLASSNAME : 'fas fa-smile-o'});
				$.FroalaEditor.DefineIcon('insertTable', {CLASSNAME : 'fas fa-table'});
				$.FroalaEditor.DefineIcon('html', {CLASSNAME : 'fas fa-code'});
				$.FroalaEditor.DefineIcon('tableHeader', {CLASSNAME : 'fas fa-header'});
				$.FroalaEditor.DefineIcon('tableRemove', {CLASSNAME : 'fas fa-trash'});
				$.FroalaEditor.DefineIcon('tableRows', {CLASSNAME : 'fas fa-bars'});
				$.FroalaEditor.DefineIcon('tableColumns', {CLASSNAME : 'fas fa-bars fa-rotate-90'});
				$.FroalaEditor.DefineIcon('tableStyle', {CLASSNAME : 'fas fa-paint-brush'});
				$.FroalaEditor.DefineIcon('tableCells', {CLASSNAME : 'fa fa-square-o'});
				$.FroalaEditor.DefineIcon('tableCellBackground', {CLASSNAME : 'fas fa-paint-roller text-16'});
				$.FroalaEditor.DefineIcon('tableCellVerticalAlign', {CLASSNAME : 'fa fa-arrows-v'});
				$.FroalaEditor.DefineIcon('tableCellHorizontalAlign', {CLASSNAME : 'fas fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('tableCellStyle', {CLASSNAME : 'fas fa-magic text-16'});
				$.FroalaEditor.DefineIcon('image-align', {CLASSNAME : 'fa fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('image-align-left', {CLASSNAME : 'fa fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('image-align-right', {CLASSNAME : 'fa fa-align-right text-16'});
				$.FroalaEditor.DefineIcon('image-align-center', {CLASSNAME : 'fa fa-align-justify text-16'});
				$.FroalaEditor.DefineIcon('imageAlign', {CLASSNAME : 'fa fa-align-justify text-16'});
				$.FroalaEditor.DefineIcon('imageRemove', {CLASSNAME : 'fa fa-trash'});
				$.FroalaEditor.DefineIcon('imageLink', {CLASSNAME : 'fa fa-link text-16'});
				$.FroalaEditor.DefineIcon('imageDisplay', {CLASSNAME : 'fa fa-star'});
				$.FroalaEditor.DefineIcon('imageStyle', {CLASSNAME : 'fa fa-magic text-16'});
				$.FroalaEditor.DefineIcon('imageAlt', {CLASSNAME : 'fa fa-info'});
				$.FroalaEditor.DefineIcon('imageSize', {CLASSNAME : 'fa fa-arrows-alt'});
				$.FroalaEditor.DefineIcon('videoReplace', {CLASSNAME : 'fa fa-exchange'});
				$.FroalaEditor.DefineIcon('videoRemove', {CLASSNAME : 'fa fa-trash'});
				$.FroalaEditor.DefineIcon('videoDisplay', {CLASSNAME : 'fa fa-star'});
				$.FroalaEditor.DefineIcon('video-align', {CLASSNAME : 'fa fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('video-align-left', {CLASSNAME : 'fa fa-align-left text-16'});
				$.FroalaEditor.DefineIcon('video-align-right', {CLASSNAME : 'fa fa-align-right text-16'});
				$.FroalaEditor.DefineIcon('video-align-center', {CLASSNAME : 'fa fa-align-justify text-16'});
				$.FroalaEditor.DefineIcon('videoAlign', {CLASSNAME : 'fa fa-align-justify text-16'});
				$.FroalaEditor.DefineIcon('videoSize', {CLASSNAME : 'fa fa-arrows-alt'});
				$.FroalaEditor.DefineIcon('videoByURL', {CLASSNAME : 'fa fa-link'});
				$.FroalaEditor.DefineIcon('videoEmbed', {CLASSNAME : 'fa fa-code'});
			}
			...
			var default_option = {
				...
				//toolbarSticky: false,
				fontSize : ['8', '9', '10', '11', '12', '13', '14', '16', '18', '20', '22', '24', '26', '30', '36', '48', '60', '72', '96'],
				toolbarButtons : ["bold", "italic", "underline", "strikeThrough", "fontFamily", "fontSize", 'emoticons', '|', "clearFormatting", "color", "align", "formatOL", "formatUL", 'quote', "insertHR", '|', 'insertLink', image_insert, 'insertVideo', file_insert, 'insertTable', "html"],
				toolbarButtonsMD : ["bold", "italic", "underline", "strikeThrough", "fontFamily", "fontSize", 'emoticons', '|', "clearFormatting", "color", "align", "formatOL", "formatUL", 'quote', "insertHR", '|', 'insertLink', image_insert, 'insertVideo', file_insert, 'insertTable', "html"],
				toolbarButtonsSM : ["bold", "italic", "underline", "strikeThrough", "fontFamily", "fontSize", 'emoticons', '|', "clearFormatting", "color", "align", "formatOL", "formatUL", 'quote', "insertHR", '|', 'insertLink', image_insert, 'insertVideo', file_insert, 'insertTable', "html"],
				toolbarButtonsXS : [image_insert, 'insertVideo', 'insertLink', file_insert, '|', "fontSize", "bold", "italic", "underline", "strikeThrough", "align", "color", "clearFormatting", '|', 'quote', "insertHR", "formatOL", "formatUL"],
				language : 'ko',
				...
				iconsTemplate : is_custom_mobile ? 'custom_icon' : 'font_awesome',
				mobile_custom : false,
				change_content : function(){
			...
			$froala_obj.on('froalaEditor.initialized', function(e, editor){
				...
				function resizeToolbar(){
					...
					if(is_custom_mobile){
						...
						var tbPadding = 10;
						var tbWidth = 0;
						editor.$tb.children(".fr-btn, .fr-separator, .fr-btn-wrap").filter(function(){
							return $(this).css('display') !== 'none';
						}).each(function(index){
							tbWidth += Math.ceil($(this).outerWidth(true));
						});
						tbWidth += tbPadding * 2;
						editor.$tb.width(tbWidth);
						editor.$tb.css('padding', '0 ' + tbPadding + 'px');
						// 스크롤 수동 구현(Froala 에디터 내부에서 터치 이벤트 가로채기로 overflow scroll이 동작하지 않음)
						var touchStart = false;
						var scrollStart = false;
						var touchStartX = false;
						var beforeX = false;
						var tbLeftEnd = (tbWidth - $(window).width()) * -1;
						editor.$tb.on(pointerDownName, function(e){
							scrollStart = false;
							beforeX = false;
							touchStart = true;
							if(pointerDownName !== 'touchstart'){
						...
						editor.$tb.off(pointerMoveName).on(pointerMoveName, function(e){
							// 글꼴 크기 등 드롭다운이 내려가 있을 때는 움직이면 안됨
							if(touchStart && editor.$tb.find('.fr-dropdown.fr-active').length === 0 && editor.$tb.find('.fr-popup.fr-active').length === 0){
								if(pointerMoveName !== 'touchmove'){
									var nowX = e.originalEvent.pageX;
								}else{
									var nowX = e.originalEvent.touches[0].pageX;
								}
								var tbOffset = editor.$tb.offset();
								if(scrollStart){
									var tbX = tbOffset.left + nowX - beforeX;
									if(tbX > 0){
										tbX = 0;
									...
									editor.$tb.offset({top : tbOffset.top, left : tbX});
									beforeX = nowX;
								}else if(Math.abs(touchStartX - nowX) > 50){
									scrollStart = true;
									var tbX = tbOffset.left + nowX - touchStartX;
						...
						if(!IS_MOBILE){
							editor.$tb.on('mousewheel', function(e){
								if(editor.$tb.find('.fr-dropdown.fr-active').length === 0 && editor.$tb.find('.fr-popup.fr-active').length === 0){
									var tbOffset = editor.$tb.offset();
									var tbX = tbOffset.left + e.originalEvent.wheelDelta;
									if(tbX > 0){
										tbX = 0;
							...
							editor.$tb.on('mouseleave', function(e){
								touchStartX = false;
								scrollStart = false;
								beforeX = false;
								touchStart = false;
						...
						var tbOffset = editor.$tb.offset();
						if(tbOffset.left < tbLeftEnd){
							editor.$tb.offset({top : tbOffset.top, left : tbLeftEnd});
						}
					}else{
						editor.$tb.off(pointerMoveName);
						editor.$tb.off('mousewheel');
						editor.$tb.css('left', '');
						editor.$tb.css('top', '');
						editor.$tb.css('padding', '');
						editor.$tb.css('width', '');
					}
				}
			...
			var ios_tmp_agent = "";
			$froala_obj.on('froalaEditor.paste.before', function(e, editor){
			...
			$froala_obj.on('froalaEditor.paste.beforeCleanup', function(e, editor){
...
/**
 * 화면 아래에서 올라오는 시트 다이얼로그 (대시보드만 css 대응)
...
/**
 * imSheet 디자인의 셀렉트 다이얼로그 (대시보드만 css 대응)
